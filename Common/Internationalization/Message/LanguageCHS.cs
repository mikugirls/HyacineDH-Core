...
public class ServerInfoTextCHS
{
    ...
    public string StartingServer => "正在启动 HyacineCore…";
    ...
    public string MissionEnabled => "任务系统已启用，此功能仍在开发中，且可能不会按预期工作。";
    public string CacheLoadSkip => "已跳过缓存加载。";
    public string MissionLoadSkipped => "EnableMission 为 false，已跳过任务/剧情资源加载。";
    ...
    public string KeyExchangeSuccess => "{0} 密钥交换成功";
