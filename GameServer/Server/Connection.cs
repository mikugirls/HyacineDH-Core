...
using HyacineCore.Server.Enums.Server;
...
public class Connection(KcpConversation conversation, IPEndPoint remote) : HyacineCoreConnection(conversation, remote)
{
    ...
    public override void Stop()
    {
        ...
        HyacineCoreListener.UnregisterConnection(this);
        base.Stop();
    }
        ...
        if (handler != null)
        {
            ...
            catch (Exception e)
            {
                ...
                var typ = AppDomain.CurrentDomain.GetAssemblies()
                    .SingleOrDefault(assembly => assembly.GetName().Name == "Proto")!.GetTypes()
